...
namespace LinkeD365.MockDataGen
{
    ...
    [ExportMetadata("Name", "Mockaroo Data Munger")]
    [ExportMetadata("Description", "Tool to create data using the Mockaroo API")]
    ...
    public class MockDataGen : PluginBase, IPayPalPlugin
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new MockDataGenCtl();
        }

...
namespace LinkeD365.MockDataGen
{
    public static class DataTypes
    {
        ...
        {
            public const string RandomLookup = "Random Lookup";
            ...
            public const string FixedString = "Fixed String";
            public const string FixedDateTime = "Fixed Date Time";

            public const string FixedTime = "Fixed Time";

            public const string FixedTeam = "Fixed Team";
            public const string RandomTeam = "Random Team";
        ...
        public const string CharSequence = "Character Sequence";
